...
from crawler.spiders.carrier_ymlu_multi import ContainerStatusRoutingRule
from test.spiders.carrier_ymlu_multi import container_status
...
def test_main_info_routing_rule(sub, mbl_no, container_no, follow_url, sample_loader):
    ...
    container_status_request_option = ContainerStatusRoutingRule.build_request_option(
        task_id=1, follow_url=follow_url, container_no=container_no, headers={}
    )
