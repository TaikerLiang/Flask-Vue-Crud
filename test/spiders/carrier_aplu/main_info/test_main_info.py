...
# from crawler.core_carrier.anlc_aplu_cmdu_share_spider import CargoTrackingRule as MultiFirstTierRoutingRule
...
#         search_nos=[mbl_no], base_url=MultiCarrierApluSpider.base_url, search_type=SHIPMENT_TYPE_MBL, task_ids=[1]
#     )
