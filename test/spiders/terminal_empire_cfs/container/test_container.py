...
from crawler.spiders.terminal_empire_cfs import ContainerRoutingRule
from test.spiders.terminal_empire_cfs import container
...
def test_container_handle(sub, container_no, sample_loader):
    ...
    response = TextResponse(
        ...
        body=http_text,
        encoding="utf-8",
        request=Request(url=option.url, meta={"container_no": container_no}),
    )
