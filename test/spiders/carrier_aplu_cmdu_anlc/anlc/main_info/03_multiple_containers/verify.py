from crawler.spiders.carrier_aplu_cmdu_anlc import SharedUrlFactory, CarrierAnlcSpider, UrlSpec


def verify(results):
    url_factory = SharedUrlFactory(home_url=CarrierAnlcSpider.home_url, mbl_no='AWT0143454')
