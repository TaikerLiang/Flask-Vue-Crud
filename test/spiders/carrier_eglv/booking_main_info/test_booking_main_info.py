...
from crawler.spiders.carrier_eglv import BookingMainInfoRoutingRule
from test.spiders.carrier_eglv import booking_main_info
...
def test_main_info_handler(sub, booking_no, sample_loader):
    ...
    option = BookingMainInfoRoutingRule.build_request_option(task_id="1", booking_no=booking_no, verification_code="")
