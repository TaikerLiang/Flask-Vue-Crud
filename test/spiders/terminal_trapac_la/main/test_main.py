...
from crawler.spiders.terminal_trapac_la import TerminalTrapacLASpider
from test.spiders.terminal_trapac_la import main
...
@pytest.mark.parametrize(
    'sub,container_no',
    [
        ('01_basic', 'GAOU6334583'),
        ('02_no_holds', 'TGHU6961213'),
    ],
)
def test_main_routing_rule(sub, container_no, sample_loader):
    ...
    option = MainRoutingRule.build_request_option(
        ...
        company_info=TerminalTrapacLASpider.company_info,
    )
