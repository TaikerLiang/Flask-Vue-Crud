...
from test.spiders.carrier_oney_smlm_multi.smlm import vessel
...
def test_vessel_routing_handle(sub, mbl_no, bkg_no, sample_loader):
    ...
    option = VesselRoutingRule.build_request_option(booking_no=bkg_no, base_url=CarrierSmlmSpider.base_url, task_id=1)
