...
from crawler.core_carrier.oney_smlm_multi_share_spider import VesselRoutingRule
from test.spiders.carrier_oney_smlm_multi.oney import vessel
...
def test_vessel_handle(sub, mbl_no, bkg_no, sample_loader):
    ...
    option = VesselRoutingRule.build_request_option(booking_no=bkg_no, base_url=CarrierOneySpider.base_url, task_id=1)
