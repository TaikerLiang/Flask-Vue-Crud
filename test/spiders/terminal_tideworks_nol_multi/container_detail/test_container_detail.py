...
from test.spiders.terminal_tideworks_nol_multi import container_detail
from crawler.spiders.terminal_tideworks_nol_multi import TerminalTideworksNolSpider
...
def test_container_detail_routing_rule(sub, container_no, sample_loader):
    ...
    container_url = f"/fc-NOL/import/default.do?method=container&eqptNbr={container_no}&gkey=20913717"
    request_option = ContainerDetailRoutingRule.build_request_option(
        container_url=container_url, company_info=TerminalTideworksNolSpider.company_info
    )
