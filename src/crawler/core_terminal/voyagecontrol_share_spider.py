...
class ListTracedContainerRoutingRule(BaseRoutingRule):
    ...
    def handle(self, response):
        ...
        container = self._get_container_from(response_json=response_json, container_no=container_no)
        ...
        if container:
            ...
            collated_container = self._extract_container_info(container=container)

            yield ContainerInquiryRoutingRule.build_request_option(
                authorization_token=authorization_token, company_info=company_info, container_data=collated_container
            )
    ...
    @staticmethod
    def _get_container_from(response_json: Dict, container_no: str):
    ...
    def _extract_container_info(self, container: Dict) -> Dict:
    ...
    @staticmethod
    def _extract_container_status(contain_container_status):
...
class ContainerInquiryRoutingRule(BaseRoutingRule):
    ...
    @classmethod
    def build_request_option(
        cls, authorization_token, company_info: CompanyInfo, container_data: Dict
    ) -> RequestOption:
