...
class ListTracedContainerRoutingRule(BaseRoutingRule):
    ...
    def __extract_container_info(self, container: Dict) -> Dict:
        ...
        return {
            ...
            'appointment_date': container['status']['APPOINTMENT_HOLD'] or None,
            'last_free_day': container['status']['PORT_LFD'],
            'demurrage': container['status']['DEMURRAGE'],
            'holds': container['status']['HOLD_INFO'] or None,
            'cy_location': container['status']['LOCATIONDETAILS'],
        }
